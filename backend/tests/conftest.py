...
from app.database import Base, set_test_engine
...
def clean_db(db):
    ...
    for model in (DocumentChunk, Document, ChatMessage, ChatSession, UsageMetric, WorkflowRun, Workflow, Subscription, User):
